...
extern "C" void initDCT8x8(cl_context cxGPUContext, cl_command_queue cqParamCommandQue, const char **argv){
    ...
    shrLog(LOGBOTH, 0, "Loading OpenCL DCT8x8...\n");
    ...
    shrLog(LOGBOTH, 0, "Creating DCT8x8 program...\n");
        cpDCT8x8 = clCreateProgramWithSource(cxGPUContext, 1, (const char **)&cDCT8x8, &kernelLength, &ciErrNum);
        shrCheckError (ciErrNum, CL_SUCCESS);

    shrLog(LOGBOTH, 0, "Building DCT8x8 program...\n");
        ciErrNum = clBuildProgram(cpDCT8x8, 0, NULL, "-cl-mad-enable", NULL, NULL);
        shrCheckError (ciErrNum, CL_SUCCESS);

    shrLog(LOGBOTH, 0, "Creating DCT8x8 kernels...\n");
