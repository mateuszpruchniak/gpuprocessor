...
# Includes
INCLUDES  += -I$(INCDIR) -I$(OCLCOMMONDIR)/inc -I$(SHAREDDIR)/inc  -I /usr/include/opencv -lcv -lhighgui -lstdc++

ifeq "$(strip $(HP_64))" ""
	MACHINE := 32
	USRLIBDIR := -L/usr/lib/  -L /usr/local/lib
else
	MACHINE := 64
	USRLIBDIR := -L/usr/lib64/ -L /usr/local/lib
endif
...
ifneq ($(STATIC_LIB),)
    ...
    ifeq ($(dbg),1)
	    LIB += -loclUtilD -lshrutilD  -lcv -lhighgui -lstdc++
	else
	    LIB += -loclUtil -lshrutil  -lcv -lhighgui -lstdc++
	endif
